...
public class Captcha {
    ...
    public static final String CAPTCHA_CHARACTER_SETS = "123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    private static Random random = new Random();

    public static String outputCaptchaImage(int width, int height, OutputStream os, int captchaLength) throws IOException {
        String captcha = generateCaptcha(captchaLength);
        outputImage(width, height, os, captcha);
        return captcha;
    }

    public static String generateCaptcha(int captchaLength) {
        return generateCaptcha(captchaLength, CAPTCHA_CHARACTER_SETS);
    }

    public static String generateCaptcha(int captchaLength, String sources) {
        if (sources == null || sources.length() == 0) {
            sources = CAPTCHA_CHARACTER_SETS;
        }
    ...
    public static String outputCaptchaImage(int width, int height, File outputFile, int captchaLength) throws IOException {
